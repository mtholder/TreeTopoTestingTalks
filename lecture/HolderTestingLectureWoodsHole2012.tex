...
\myNewSlide
\begin{itemize}
	\item \citet{EfronHH1996} pointed out these issues of curvature of the boundaries between tree hypotheses.
...
\begin{itemize}
	...
	\item \citet{Shimodaira2002} used the same theoretical framework to devise a (more feasible) Approximately Unbiased (AU) test of topologies. Multiple scales of bootstrap resampling are used to detect and correct for curvature of the boundary.
\end{itemize}

...
\begin{compactitem}
	...
	\item $\expect{Y}$ denotes the expected value of some statistic, $Y$.  You can think of the expected value as the mean that you would calculate if you could perform a large number of simulations.
	\item $\bar y$ denotes the mean value of some observed statistics.
\end{compactitem}
